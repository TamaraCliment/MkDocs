...
3. [Configuración de MkDocs](configuracion/configuracion.md)
4. [Personalización con CSS y JS](personalizacion/estilos.md)
5. [Extensiones de Markdown](extensiones/admonitions.md)
